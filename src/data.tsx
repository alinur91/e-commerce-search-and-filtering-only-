...
export const filterByData = {
  category: ["all", "sneakers", "flats", "sandals", "heels"],
  price: ["all", "$0-$50", "$50-$100", "$100-$150", "Over $150"],
  colors: ["all", "black", "blue", "red", "green", "white"],
};

export const companyArray = ["All Products", "Nike", "Adidas", "Puma", "Vans"];

export const data: Array<ProductType> = [
  {
    img: "https://m.media-amazon.com/images/I/6125yAfsJKL._AC_UX575_.jpg",
    title: "Nike Air Monarch IV",
    star: <AiFillStar color="orange" />,
    reviews: "(123 reviews)",
    prevPrice: "$140,00",
    newPrice: "115",
    company: "Nike",
